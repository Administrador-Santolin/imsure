import { Component, OnInit, OnDestroy, inject, Inject } from '@angular/core'; // Adicione OnInit, OnDestroy
...
export class Dashboard implements OnInit, OnDestroy { // Implemente OnInit, OnDestroy
